          ...
          <div
            ...
            style={{
              backgroundImage:
                ...
                "url('https://media.istockphoto.com/id/1046980432/photo/bangladeshi-money-a-background.jpg?s=2048x2048&w=is&k=20&c=3JoVdOtyE_DgJvxoNKPv602CTxzs0Whe7ShYWAXi50A=')",
            }}
          >
            <span
              id='blackOverlay'
            ...
            <div className='items-center flex flex-wrap'>
              <div className='w-full lg:w-6/12 px-4 ml-auto mr-auto text-center'>
                <div className='pr-12'>
                  ...
                  CSE 448: Web Technologies Bank LTD.
                  </h1>
                  <h3 className='text-white font-semibold text-xl'>Money is not just a paper ...</h3>
